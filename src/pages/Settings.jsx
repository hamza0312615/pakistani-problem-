    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12 slide-in">
      ...
      <div className="border-b border-white/10 pb-6">
        ...
        <p className="text-sm text-white/60 mt-1 max-w-2xl">
          Configure your Groq & Gemini API credentials and WhatsApp Doctor triage routing preferences for Pakistan Ka Digital Doctor.
        </p>
      </div>
      ...
      <div className="glass-card p-8 sm:p-10 rounded-3xl border border-white/10 shadow-2xl space-y-8 relative overflow-hidden">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-white/50 leading-relaxed">
            Pakistan Ka Digital Doctor operates 100% client-side. Your API keys and WhatsApp configurations are stored securely in your browser's local storage and are never transmitted to any external server.
          </p>
        </div>
      ...
      <div className="glass-card-light p-8 rounded-3xl border border-white/5 space-y-6 shadow-xl">
        ...
        <div className="p-6 rounded-2xl bg-blue-500/10 border border-blue-500/20 text-blue-300 space-y-2 shadow-inner">
          ...
          <p className="text-xs leading-relaxed text-white/80">
            Pakistan Ka Digital Doctor is an AI-powered medical diagnostics demonstration platform. All evaluations, recommendations, and risk assessments are generated by artificial intelligence models and are not a substitute for professional medical advice, diagnosis, or treatment. Always consult a qualified healthcare provider with any medical questions or emergencies.
          </p>
        </div>
      </div>
    </div>
